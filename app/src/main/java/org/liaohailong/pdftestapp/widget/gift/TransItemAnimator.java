...
/**
 * Describe as: 平移进入/平移退出
 * Created by LHL on 2018/8/26.
 */
public class TransItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        final int measuredWidth = holder.itemView.getMeasuredWidth();
        animation.setDuration(getRemoveDuration()).translationX(-measuredWidth)
                .setListener(
    ...
    public boolean animateAdd(final RecyclerView.ViewHolder holder) {
        ...
        holder.itemView.setTranslationX(-measuredWidth);
    ...
    private void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.translationX(0f).setDuration(getAddDuration())
